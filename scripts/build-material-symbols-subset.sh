...
ICONS="home_max,explore,photo_library,account_tree,terminal,download,share,work,link,arrow_forward,bolt,cell_tower,my_location,layers,sensors,schedule,person,send,close,key,logout,fingerprint,account_circle,mail,hub,code,language,database,search,filter_list"
